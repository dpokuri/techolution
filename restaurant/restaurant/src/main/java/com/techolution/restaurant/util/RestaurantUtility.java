package com.techolution.restaurant.util;
...
/**
 * RestaurantUtility is a Spring Component Managed Bean and implements KnapSack
...
public class RestaurantUtility {
	private static final Logger logger = LoggerFactory.getLogger(RestaurantUtility.class);
